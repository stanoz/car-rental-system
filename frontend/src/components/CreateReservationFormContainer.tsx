...
export default function CreateReservationFormContainer() {
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <div className="flex w-[28rem] text-2xl text-cyan-50 justify-between">
                ...
                {stepNumber == 4 && <button type="button" className={`mr-0 ml-auto bg-green-700 hover:bg-green-800 ${commonClasses}`}>Create Reservation</button>}
            </div>
        </div>
    );
}
